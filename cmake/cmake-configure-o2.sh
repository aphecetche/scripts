...
-DGeant3_DIR="$install/$platform/GEANT3/$version/$g3lib" \
-DGeant4_DIR="$install/$platform/GEANT4/$version/lib" \
-DGEANT4_VMC_DIR="$install/$platform/GEANT4_VMC/$version/lib" \
-DVGM_DIR="$install/$platform/vgm/$version/lib" \
-DVc_DIR="$install/$platform/Vc/$version/lib/cmake/Vc" \
-DCMAKE_PREFIX_PATH="$install/$platform/vgm/$version/lib/VGM-4.4.0;$install/$platform/GEANT4_VMC/$version/lib/Geant4VMC-3.5.0;$install/$platform/GEANT4/$version/lib/Geant4-10.3.3;$install/$platform/GEANT3/$version/$g3lib/Geant3-2.5.0;$install/$platform/ROOT/$version;$install/$platform/Vc/$version;$install/$platform/FairRoot/$version" \
