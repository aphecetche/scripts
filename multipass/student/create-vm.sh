...
time multipass exec ${NAME} -- bash -c ". ~/spack/share/spack/setup-env.sh && spack env activate ~/nantes-m2-rps-exp/qqbar2mumu-2021 && time spack install --fail-fast --cache-only"
